const headingsMapService = function () {
    ...
    function headingsMap(settings = {}) {
        ...
        function generateHeadingsMap() {
            ...
            const headingsMapSection = generateSectionForMap('headings structure');
            ...
            if (!headingElementsLength) {
                ...
                let noHeadingsTextNode = createTextNode(i18n.noHeadings);
            ...
            for (let i = 0; i < headingElementsLength; i++) {
                ...
                tooltipData.push({content: `${i18n.headingLevel} ${currentLevel}`})
                tooltipData.push({content: `${i18n.element} ${tagName}`})
                ...
                if(emptyHeader){
                    tooltipData.push({content: [i18n.error, i18n.emptyHeader], attributes: {class: tooltipErrorClass}});
                }
                if(incorrectLevel){
                    tooltipData.push({content: [i18n.error, missingH1 ? i18n.missingH1 : i18n.wrongHierarchy], attributes: {class: tooltipErrorClass}});
                }
                if(sectionRef){
                    tooltipData.push({content: i18n.clickTheAnchor, attributes: {class: anchorClass}});
                }
                if(!isVisible){
                    tooltipData.push({content: i18n.potentiallyHidden, attributes: {class: visibilityClass}});
                }
                ...
                tooltipData.forEach((data) => {
                    ...
                    const tooltipDataItem = createElement('div', attributes, [dataAttribute, dataValue]);
